...
public class DashboardView {
   ...
   private MainApp mainApp;
    ...
    public static final String ICONE_AVEC = "🏘️"; // ou "🏛️" ou "🏢"
    ...
    private VBox createSidebar() {
        ...
        Button avecBtn = createMenuButton("🏘️", "AVEC", this::showAvecView);
...
//                createMenuButton(ICONE_VISITES, "Visites de terrain", this::showVisiteView)
    		   agentTerrainBtn,agentVillageoisBtn,avecBtn
           );
...
//    private void showAvecView() {
//        try {
//            // Utiliser le constructeur sans Stage
//            Long agentVillageoisId = 0L;
//
//            AvecView avecView = new AvecView( primaryStage, agentVillageoisId);
//
//            // Récupérer le contenu et l'afficher
//            VBox viewContent = avecView.getRoot();
//            root.setCenter(viewContent);
//
//        } catch (Exception e) {
//            e.printStackTrace();
//            AlertUtils.showError("Erreur", "Impossible d'ouvrir la vue AVEC", e.getMessage());
//        }
//    }

    private void showAvecView() {
        AvecView avecView = new AvecView(mainApp, utilisateur);  // ← Utiliser MainApp
        root.setCenter(avecView.getRoot());
    }
...
//    }
    ...
    private void showAgentVillageoisView() {
        AgentVillageoisDashboardView agentVillageoisView = new AgentVillageoisDashboardView(mainApp);
